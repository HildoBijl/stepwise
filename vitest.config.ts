...
const migratedPackages = ['bernstein-polynomials', 'exercise-bundling', 'exercise-definition', 'js-utils', 'math-tools', 'polynomials', 'settings', 'skill-definition', 'skill-setup']
