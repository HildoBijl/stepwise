...
const migratedPackages = ['bernstein-polynomials', 'course-definition', 'engineering-mechanics', 'exercise-bundling', 'exercise-definition', 'exercise-grading', 'exercise-selection', 'geometry', 'interpolation', 'input-exercises', 'input-interpretation', 'js-utils', 'math-input-value', 'math-tools', 'physics-core', 'physics-data', 'polynomials', 'serialization', 'settings', 'skill-definition', 'skill-setup', 'skill-tracking', 'skill-tree']
