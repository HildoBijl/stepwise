...
const migratedPackages = ['bernstein-polynomials', 'course-definition', 'exercise-bundling', 'exercise-definition', 'interpolation', 'js-utils', 'math-tools', 'polynomials', 'settings', 'skill-definition', 'skill-setup', 'skill-tree']
