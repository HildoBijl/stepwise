...
const { isInt, ensureInt, isNumber, ensureNumber, roundToDigits, isObject, mergeDefaults, fromKeys } = require('@step-wise/utils')
...
class Float {
	...
	get SO() {
		return fromKeys(Object.keys(defaultParameters), key => this[key] === defaultParameters[key] ? undefined : this[key])
	}
