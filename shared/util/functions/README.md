...
- [fundamentals](./fundamentals.js) has the main functionalities, like checking if something is a function, as well as some standard often-used functions (`noop`, `identity`).
