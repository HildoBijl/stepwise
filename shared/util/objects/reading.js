...
// getByPath takes an object like { x: { y: 1, z: 2}, w: 3 } and an array of indices ['x', 'z']. It looks up the corresponding nested value in the object. So it finds obj['x']['z'].
...
// stringifyJS will JSON stringify an object but not like {"x":"a"}. Instead, it will give {x:"a"}. No quotes will be used around properties.
...
module.exports.stringifyJS = stringifyJS
