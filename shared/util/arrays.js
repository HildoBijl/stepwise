...
// getMatrixElement takes a matrix and set of indices and returns its value from the matrix. For instance, getMatrixElement(matrix, [2,0,1]) will extract matrix[2][0][1].
