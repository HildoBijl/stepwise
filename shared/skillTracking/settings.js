module.exports = {
	...
	defaultInferenceOrder: 12, // The order applied to inference on skills through their set-ups.
	defaultLinkOrder: 6, // The order applied to inference on skills through correlation links.
