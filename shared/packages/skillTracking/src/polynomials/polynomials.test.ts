...
import { applyMinus, addConstant, multiplyByConstant, oneMinus, add, multiply } from './addAndMultiply'
import { restructure, substitute, substituteAll } from './restructureAndSubstitute'
import { polynomialMatrixToString } from './display'
...
describe('Check mathematical functions:', () => {
	...
	describe('add', () => {
		it('works correctly', () => {
			...
			const applied1 = add([
				{ matrix: matrix1, list: list1 },
				{ matrix: matrix2, list: ['b'] },
			])
