...
export function isMinusOne(node: ExpressionNode): node is Sign { return isMinus(node) && isOne(node.node) }
...
export function isNonPositiveConstant(node: ExpressionNode): node is ConstantNode | Sign { return isZero(node) || (isMinus(node) && isNonNegativeConstant(node.node)) }
export function isNegativeConstant(node: ExpressionNode): node is ConstantNode | Sign { return isMinus(node) && isPositiveConstant(node.node) }

// Integers
export function isInteger(node: ExpressionNode): node is Integer | Sign { return isIntegerNode(node) || (isMinus(node) && isIntegerNode(node.node)) }
...
export function isNonPositiveInteger(node: ExpressionNode): node is Integer | Sign { return (isIntegerNode(node) && isZero(node)) || (isMinus(node) && isNonNegativeInteger(node.node)) }
export function isNegativeInteger(node: ExpressionNode): node is Sign { return isMinus(node) && isPositiveInteger(node.node) }

// Floats
export function isFloat(node: ExpressionNode): node is Float | Sign { return isFloatNode(node) || (isMinus(node) && isFloatNode(node.node)) }
...
export function isNonPositiveFloat(node: ExpressionNode): node is Float | Sign { return (isFloatNode(node) && isZero(node)) || (isMinus(node) && isNonNegativeFloat(node.node)) }
export function isNegativeFloat(node: ExpressionNode): node is Sign { return isMinus(node) && isPositiveFloat(node.node) }
