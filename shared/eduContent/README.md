...
In the `eduContent` folder you find all educational content. This also includes a few tools that are only relevant for certain contents. (General tools are in the [eduTools](../eduTools/) folder.) In this shared `eduContent` folder, you mainly find files related to exercises. So let's discuss what exercises in this folder look like.
