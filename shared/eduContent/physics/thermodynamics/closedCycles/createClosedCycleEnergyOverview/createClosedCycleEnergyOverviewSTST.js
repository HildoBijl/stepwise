...
const { generateState, getSolution: getCycleParametersRaw } = require('../calculateClosedCycle/calculateClosedCycleSTST')
...
function checkInput(data, step) {
	switch (step) {
		...
		case 3:
			return compare(['Q34', 'W34'], data)
		case 4:
			return compare(['Q41', 'W41'], data)
		default:
