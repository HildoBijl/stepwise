...
function getSolution(state) {
	...
	const solutions = solution.getSingular()
	const numSolutions = solutions.length
	const [ans1] = solutions
	return { ...state, variables, equation, solutionFull, rootFull, DFull, D, solutionHalfSimplified, solution, solutions, numSolutions, ans1 }
}
