...
function getSolution(state) {
	...
	const equation = asEquation('a/b=c/(d*x)')[switchSides ? 'switch' : 'self']().substitute(variables).removeTrivial()
	const moved = asEquation('a*x/b=c/d')[switchSides ? 'switch' : 'self']().substitute(variables).removeTrivial()
