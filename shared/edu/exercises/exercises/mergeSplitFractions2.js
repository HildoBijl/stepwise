...
function getSolution(state) {
	...
	const leftAns = leftExpression.multiplyNumDen(y).simplify({ removeUseless: true, mergeProductNumbers: true, mergeProductTerms: true, mergeSumNumbers: true, sortProducts: true })
	const rightAns = rightExpression.multiplyNumDen(x).simplify({ removeUseless: true, mergeProductNumbers: true, mergeProductTerms: true, mergeSumNumbers: true, sortProducts: true })
