...
class Expression {
	...
	become(SO) {
		...
		SO = mergeDefaults(SO, this.constructor.getDefaultSO())
		...
		if (settings)
			this.applySettingsToSelf(mergeDefaults(settings, defaultExpressionSettings))
	}
...
class Variable extends Expression {
	become(SO) {
		...
		// Handle parent input.
		super.become(pickFromDefaults(SO, getParentClass(this.constructor).getDefaultSO()))
...
class Power extends Function {
	...
	simplifyBasic(options) {
		...
		if (options.reducePowersWithOneBase) {
