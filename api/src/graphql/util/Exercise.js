...
import { checkSkillIds } from './Skill'
...
export async function getActiveExerciseData(userId, skillId, db, requireExercise = true) {
...
export function getLastEvent(exercise) {
