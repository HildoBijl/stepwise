...
const Problem = ({ p1, p2, V1, V2, T1 }) => <>
	...
	<InputSpace><Par><QuantityInput id="T2" prelabel={<M>T=</M>} label="Temperatuur" size="s" /></Par></InputSpace>
</>
...
const steps = [
	...
	},
	{
		Problem: () => <>
			...
			<InputSpace>
				<Par><QuantityInput id="T2" prelabel={<M>T=</M>} label="Temperatuur" size="s" /></Par>
			</InputSpace>
		</>,
