	...
	return <>
		...
		<InputSpace>
			<Par>
				...
				<QuantityInput id="Pc" prelabel={<M>P_(koel) =</M>} label="Koelvermogen" size="s" />
			</Par>
		</InputSpace>
	</>
}
		...
		Problem: () => <>
			...
			<InputSpace>
				<Par>
					...
					<Substep ss={2}><QuantityInput id="Pc" prelabel={<M>P_(koel) =</M>} label="Koelvermogen" size="s" /></Substep>
				</Par>
			</InputSpace>
		</>,
