...
const steps = [
	...
	},
	{
		...
		Solution: ({ Wn, Q12, Qin, Qout, epsilon, COP }) => {
...
const getFeedback = (exerciseData) => {
	return {
		...getFieldInputFeedback(exerciseData, ['p1', 'V1', 'T1', 'p2', 'V2', 'T2', 'p3', 'V3', 'T3', 'Q12', 'W12', 'Q23', 'W23', 'Q31', 'W31', 'epsilon', 'COP']),
