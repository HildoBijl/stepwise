...
const steps = [
	...
	},
	{
		...
		Solution: ({ p4, V1, V4, Q12, W12, Q23, W23, Q34, W34, Q41, W41, Qn, Wn }) => {
			return <>
				<Par>Net als bij stap 2-3 geldt hier <BM>Q_(4-1) = W_(4-1) = pV\ln\left(\frac(V_1)(V_4)\right) = {p4.value} \cdot {V4.value} \cdot \ln\left(\frac{V1.value}{V4.value}\right) = {Q41}.</BM> Daarmee is ook de laatste stap doorgerekend.</Par>
