...
import { M, BMList, BMPart } from '@step-wise/math-display'
...
export default function Component() {
	return <>
		...
		<Par>Per definitie is <M>c_v</M> de <Term>soortelijke warmte bij constant volume</Term>: als je een gas met constant volume verwarmt, hoeveel Joule is er dan nodig om één kilogram gas één graad Celsius (of Kelvin) in temperatuur te laten stijgen? Voor lucht is dit bijvoorbeeld <M>c_v = {gasProperties.air.cv}.</M> Soortgelijk is <M>c_p</M> de <Term>soortelijke warmte bij constante druk</Term>: als je een gas met constante druk verwarmt, hoeveel Joule is er dan nodig om één kilogram gas één graad Celsius (of Kelvin) in temperatuur te laten stijgen? Voor lucht geldt <M>c_p = {gasProperties.air.cp}.</M></Par>
