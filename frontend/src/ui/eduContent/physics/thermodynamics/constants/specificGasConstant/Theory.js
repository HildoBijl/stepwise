...
export default function Component() {
	return <>
		...
		<Head>Theorie</Head>
		<Par>De <Term>specifieke gasconstante</Term> <M>R_s {gasProperties.air.Rs.unit.texWithBrackets}</M> is een constante waarde voor een soort gas. Voor lucht geldt bijvoorbeeld <M>R_s = {gasProperties.air.Rs},</M> maar deze waarde is voor elk gas anders. Daarom heet hij ook de "specifieke" gasconstante.</Par>
		<Par>Het kan handig zijn om in gedachten te houden: hoe zwaarder het gas, hoe lager de specifieke gasconstante. Zo geldt voor waterstof (het lichtste gas) bijvoorbeeld dat <M>R_s = {gasProperties.hydrogen.Rs}</M> terwijl voor koolstofdioxide (een zwaarder gas) <M>R_s = {gasProperties.carbonDioxide.Rs}</M> geldt.</Par>
