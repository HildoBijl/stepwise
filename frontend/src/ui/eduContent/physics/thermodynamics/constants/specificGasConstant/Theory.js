...
export default function Component() {
	return <>
		...
		<Head>Theorie</Head>
		<Par>De <Term>specifieke gasconstante</Term> <M>R_s {gases.air.Rs.unit.texWithBrackets}</M> is een constante waarde voor een soort gas. Voor lucht geldt bijvoorbeeld <M>R_s = {gases.air.Rs},</M> maar deze waarde is voor elk gas anders. Daarom heet hij ook de "specifieke" gasconstante.</Par>
