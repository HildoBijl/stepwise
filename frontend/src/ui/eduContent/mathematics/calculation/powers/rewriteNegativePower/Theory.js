...
export function Theory() {
	return <>
		...
		<Translation entry="idea">
			...
			<Par>Let's do a thought experiment. Let's say we start with the number <M>2^2</M>, which we can write as <M>2 \cdot 2</M>. If we multiply this by <M>2</M>, we get <M>2 \cdot 2 \cdot 2</M> which is <M>2^3</M>. And if we do so again, we get <M>2 \cdot 2 \cdot 2 \cdot 2</M> which is <M>2^4</M>. Every time we multiply our number by the base <M>2</M>, the exponent increases by one!</Par>
