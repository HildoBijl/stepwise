...
export function Theory() {
	return <>
		...
		<Translation entry="steps">
			...
			<List items={[
				<>Find all terms that will appear in the final expansion by taking the two original terms, <SkillLink skillId="expandPowerOfProduct">calculating their various powers</SkillLink>, and multiplying the outcomes in the right way. That is, the two exponents of the two terms should always add up to the original exponent. For the example, we write down <M>\left(2x\right)^3 \cdot 3^0 = 8x^3</M>, <M>\left(2x\right)^2 \cdot 3^1 = 12x^2</M>, <M>\left(2x\right)^1 \cdot 3^2 = 18x</M> and <M>\left(2x\right)^0 \cdot 3^3 = 27</M>. Note that the exponents always add up to <M>3</M>.</>,
