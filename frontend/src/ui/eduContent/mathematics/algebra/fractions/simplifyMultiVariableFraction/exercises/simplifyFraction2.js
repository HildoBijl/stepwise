...
const Problem = () => {
	...
	return <>
		<Par>Bekijk de uitdrukking <BM>{expression}.</BM> Simplificeer deze zo veel als mogelijk.</Par>
		<InputSpace>
			<Par>
...
const steps = [
	{
		Problem: () => {
			...
			return <>
				...
				<InputSpace>
					<Par>
						<ExpressionInput id="intermediate" prelabel={<M>{expression.numerator}=</M>} label="Vul hier het resultaat in" size="l" settings={ExpressionInput.settings.withFractions} validate={ExpressionInput.validation.validWithVariables(variables)} />
					</Par>
				</InputSpace>
			</>
		},
	...
	},
	{
		Problem: () => {
			...
			return <>
				...
				<InputSpace>
					<Par>
						<ExpressionInput id="ans" prelabel={<M>{expressionWithIntermediate}=</M>} label="Vul hier het resultaat in" size="l" settings={ExpressionInput.settings.withFractions} validate={ExpressionInput.validation.validWithVariables(variables)} />
					</Par>
				</InputSpace>
			</>
		},
