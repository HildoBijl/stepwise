...
const steps = [
	{
		Problem: () => {
			...
			return <>
				...
				<InputSpace>
					<Par>
						<ExpressionInput id="factor" prelabel="Grootste factor:" label="Vul hier het resultaat in" size="l" settings={ExpressionInput.settings.rational} validate={ExpressionInput.validation.validWithVariables(variables)} />
					</Par>
				</InputSpace>
			</>
		},
...
function getFeedback(exerciseData) {
	...
	return getFieldInputFeedback(exerciseData, { ans: ansChecks, factor: factorChecks, setup: setupChecks, fractionSimplified: fractionSimplifiedChecks, expression: expressionComparisons })
}
