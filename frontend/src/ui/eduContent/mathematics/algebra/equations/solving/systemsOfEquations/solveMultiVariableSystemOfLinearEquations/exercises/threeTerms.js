...
const Problem = () => {
	...
	return <>
		<Par><Translation>Consider the system of equations <BMList><BMPart>{eq1},</BMPart><BMPart>{eq2}.</BMPart></BMList> Solve this system for <M>{variables.x}</M> and <M>{variables.y}</M>, expressing them both in <M>{variables.z}</M>. Simplify your results as much as possible.</Translation></Par>
		<InputSpace>
			<Par>
