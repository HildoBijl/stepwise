	...
	},
	{
		...
		Solution: ({ x, solutionHalfSimplified, solution, solutionsSplit, solutions, equationsSubstituted }) => {
			return <Translation>
				...
				<Par>As final check, we insert the two solutions <M>{x}_1</M> and <M>{x}_2</M> into the original equation. This results in <BM>{equationsSubstituted[0]},</BM><BM>{equationsSubstituted[1]}.</BM> Both of these equations hold, so the solutions we found are correct.</Par>
			</Translation>
		},
	},
]
