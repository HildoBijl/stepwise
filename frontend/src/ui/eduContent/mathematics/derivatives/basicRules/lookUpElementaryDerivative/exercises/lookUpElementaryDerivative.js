...
import { expressionConstants } from '@step-wise/cas'
...
const Solution = ({ f, x, func, derivative }) => {
	...
	if (func.isPower() && !func.base.equalStructure(expressionConstants.e)) {
...
function getFeedback(exerciseData) {
	...
	} else if (func.isFraction() && func.denominator.isPower() && func.denominator.exponent.isNumeric()) { // 1/x^n
	...
	} else if (func.isPower() && !func.base.equals(expressionConstants.e)) {
		const g = func.base.toNumber()
