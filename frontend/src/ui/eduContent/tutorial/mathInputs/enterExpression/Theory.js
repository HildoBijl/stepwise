	...
	return <>
		...
		<Translation entry="basics">
			...
			<List items={[
				...
				<><Term>Greek letters:</Term> <M>\alpha</M>, <M>\beta</M>, and so forth. Just type their name, like "alpha". The input field will auto-replace it for the Greek symbol.</>,
				<><Term>Accents (above variables):</Term> <M>\hat(x)</M> or <M>\dot(m)</M>. Start them by typing "hat(", "dot(" or whatever name the accent may have, with the opening bracket after it. Then enter the respective letter.</>,
			]} />
		...
		<Translation entry="function">
			...
			<List items={[
				...
				<><Term>Logarithms:</Term> <M>\log_2\left(x\right)</M>. Type "log()" on your keyboard to get a logarithm. The input field automatically assumes a base-10 logarithm, but this can of course be adjusted.</>
			]} />
