...
import { ensureNumber, ensureString, mergeDefaults } from 'step-wise/util'
...
export const Ground = forwardRef((props, ref) => {
	// Check input.
	let { position, graphicalPosition, thickness, color, rectangleOpacity, width, height, className, style } = mergeDefaults(props, defaultGround)
