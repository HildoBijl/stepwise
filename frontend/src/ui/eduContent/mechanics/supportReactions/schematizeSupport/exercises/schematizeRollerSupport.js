...
import { FBDInput, Group, Beam, RollerSupport, render, loadTypes, areLoadsEqual, FBDComparison, getFBDFeedback } from 'ui/eduContent/mechanics'
...
function getFeedback(exerciseData) {
	...
	return {
		...
		...getFBDFeedback(exerciseData, { loads: { compare: FBDComparison, feedbackChecks: loadsChecks } }),
	}
}
