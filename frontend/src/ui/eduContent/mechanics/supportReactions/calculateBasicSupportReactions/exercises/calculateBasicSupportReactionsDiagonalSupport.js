...
const Problem = () => {
	const solution = useSolution(); const { P } = solution
...
function Schematics({ l1, l2, angle, angleRad, anglePoints, points, loads, externalLoad, loadNameDefinitions, showSupports = true }) {
	const { A, B, C } = points
