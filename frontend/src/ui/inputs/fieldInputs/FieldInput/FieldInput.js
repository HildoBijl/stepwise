...
import { isEmptyObject, mergeDefaults, pickFromDefaults, resolveFunctions, identity } from '@step-wise/utils'
...
FieldInput.translatableProps = ['label', 'prelabel', 'placeholder']
