// UnitFactor represents a single unit factor like "km^3", but not a combined one like "N * m" or "m / s". It is not an input field but its functionality is used by other input fields.
...
export function UnitFactor({ value, cursor }) {
