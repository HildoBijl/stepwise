...
- [PrecisionNumberInput](./PrecisionNumberInput/) is for entering numbers with explicit precision, like 1.3 or 2.0*10^5.
- [UnitInput](./UnitInput/) is for entering only a unit, like "kg*m/s^2".
- [QuantityInput](./QuantityInput/) is for entering a number with a unit, like "2.3 km". This input field is used by the large majority of the physics exercises.
