...
export const defaultMultipleChoiceInnerOptions = {
	choices: [],
	multiple: false,
	mapping: undefined, // Ideally, we provide the MultipleChoice with a mapping setting, given by the generateMultipleChoiceMapping support function.
...
export function MultipleChoiceInner(options) {
	let { choices, multiple, mapping, pick, include, randomOrder, sx } = mergeDefaults(options, defaultMultipleChoiceInnerOptions)
