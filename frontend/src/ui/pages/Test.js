...
export default function Test() {
	...
	const svgContents = <>
		<Group style={{ opacity: 0.6 + 0.4 * Math.sin(x / 50) }}>
			...
			<Force span={{ vector: [0, 80], end: [250 + 50 * Math.sin(x / 20), 100] }} color="darkred" />
		...
		<Force span={{ vector: [0, 150], end: [450, 200] }} color="darkblue" />

		<Distance span={{ start: [150, 250], end: [450, 250] }} />
		<Distance span={{ start: [450, 250], end: [650, 250] }} />
		<Distance span={{ start: [720, 100], end: [720, 200] }} />
	</>
