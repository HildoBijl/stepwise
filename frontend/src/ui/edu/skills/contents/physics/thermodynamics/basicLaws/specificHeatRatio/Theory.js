...
export default function Component() {
	return <>
		...
		<Head>Theorie</Head>
		<Par>De <M>k</M>-waarde is afhankelijk van het soort gas. Voor lucht geldt bijvoorbeeld <M>k = {gases.air.k}.</M> De <M>k</M>-waarde wordt ook wel de verhouding van soortelijke warmten genoemd. Er geldt namelijk <M>k = \frac(c_p)(c_v),</M> waar <M>c_v</M> en <M>c_p</M> de <SkillLink skillId="specificHeats">soortelijke warmten</SkillLink> zijn. Omdat <M>c_v</M> en <M>c_p</M> beiden dezelfde eenheid hebben, heeft <M>k</M> geen eenheid. Het is puur een verhouding.</Par>
