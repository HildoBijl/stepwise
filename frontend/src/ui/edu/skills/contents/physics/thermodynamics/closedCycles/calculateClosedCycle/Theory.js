...
export default function Component() {
	return <>
		<Par>Een kringproces is een proces waarbij een medium zoals een gas meerdere (vaak 3-4) thermodynamische processen ondergaat, en ten slotte in de begintoestand terugkeert. Kringprocessen worden in de praktijk erg veel gebruikt. We kijken naar welke soorten processen er zijn en hoe we ze door kunnen rekenen.</Par>
		...
		<List items={[
			<>De <strong>Carnot-cyclus</strong>: isotherme compressie, isentrope compressie, isotherme expansie, isentrope expansie. Deze cyclus is (gegeven een bepaalde minimum en maximum temperatuur) de meest efficiënt mogelijke cyclus die bestaat. Daarom wordt hij in de praktijk erg veel toegepast. Je vindt hem (in aangepaste vorm) in elektriciteitscentrales, koelmachines, warmtepompen en talloze andere plekken.</>,
			<>De <strong>Brayton-cyclus</strong>: isentrope compressie, isobare verhitting, isentrope expansie, isobare koeling. Een voorbeeld hiervan is de gasturbine, zoals je deze vindt in vliegtuigmotoren en ook in bepaalde elektriciteitscentrales (vaak als onderdeel van een STEG-installatie).</>,
			<>De <strong>Otto-cyclus</strong>: isentrope compressie, isochore verhitting, isentrope expansie, isochore koeling. Een voorbeeld hiervan is de benzinemotor van auto's.</>,
			<>De <strong>Stirling-cyclus</strong>: isochore verhitting, isotherme compressie, isochore koeling, isotherme expansie. Deze cyclus wordt weinig gebruikt, maar omdat het een van de weinige cycli is zonder kleine explosie is hij erg stil, en wordt hij dus bijvoorbeeld nog in sommige onderzeeërs toegepast.</>,
			<>De <strong>Ericsson-cyclus</strong>: isotherme compressie, isobare verhitting, isotherme expansie, isobare koeling. Deze cyclus wordt zelden in de praktijk gebruikt.</>,
			<>De <strong>Diesel-cyclus</strong>: isentrope compressie, isobare verhitting, isentrope expansie, isochore koeling. Deze cyclus wordt gebruikt in Diesel-motoren.</>,
		]} />
		...
		<Par>Bij het invullen van het tabel zijn er enkele richtlijnen die handig zijn om te weten.</Par>
		<List items={[
