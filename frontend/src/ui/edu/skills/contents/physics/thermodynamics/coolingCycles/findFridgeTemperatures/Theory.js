...
export default function Component() {
	return <>
		<Par>Een koelmachine bestaat uit verschillende onderdelen. Als je een koelmachine ontwerpt, i de eerste stap het bepalen van welke temperatuur in welk onderdeel aanwezig moet zijn. Hier bespreken we hoe dat werkt.</Par>
		...
		<List useNumbers={true} items={[
			<>In de <em>compressor</em> wordt het koudemiddel tot een hoge druk gecomprimeerd. Hierbij stijgt ook de temperatuur.</>,
			<>In de <em>condensor</em> stroomt warmte uit het koudemiddel naar de omgeving (de keuken/woonkamer). Omdat het koudemiddel warmte afstaat condenseert het: het wordt vloeibaar. De druk en temperatuur blijven hoog.</>,
			<>In het <em>expansieventiel</em>/de <em>smoorklep</em> expandeert het koudemiddel tot een lage druk. Hierbij daalt ook de temperatuur.</>,
			<>In de <em>verdamper</em> stroomt warmte uit de omgeving (de koelruimte/buitenlucht) het koudemiddel in. Omdat het koudemiddel warmte opneemt verdampt het: het wordt gasvormig. De druk en de temperatuur blijven laag.</>,
		]} />
		...
		<List items={[
			<>In de condensor wordt warmte afgestaan aan de op te warmen ruimte. Dit is alleen mogelijk als het koudemiddel in de condensor <em>warmer</em> is dan deze ruimte. Vaak is de op te warmen ruimte zo'n <M>{T20dC}.</M> In dit geval is het koudemiddel in de condensor dus zo'n <M>{T30dC}</M> a <M>{T35dC}.</M></>,
			<>In de verdamper wordt warmte opgenomen uit de te koelen ruimte. Dit is alleen mogelijk als het koudemiddel in de verdamper <em>kouder</em> is dan deze ruimte. Vaak is de te koelen ruimte zo'n <M>{T5dC}.</M> In dit geval is het koudemiddel in de verdamper dus zo'n <M>{Tm5dC}.</M></>,
		]} />
		<Par>Mogelijk heb je wel eens gemerkt dat producten bovenin/achterin de koelkast bevroren zijn. Dat komt omdat de verdamper bovenin de koelkast zit. (Immers, koude lucht daalt.) Op die plek daalt de temperatuur dus wel eens net onder het vriespunt.</Par>
		...
		<List useNumbers={true} items={[
			...
			<>De condensor is altijd <em>warmer</em> dan de op te warmen ruimte. De verdamper is altijd <em>kouder</em> dan de af te koelen ruimte. Hiermee kun je de temperaturen in de condensor en de verdamper bepalen.</>,
		]} />
