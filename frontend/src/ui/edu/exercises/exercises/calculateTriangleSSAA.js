	...
	},
	{
		Problem: (state) => {
			...
			return <>
				...
				<InputSpace>
					<Par>
						<ExpressionInput id="γ1" prelabel={<M>{γ}_1=</M>} size="m" settings={basicTrigonometryInDegrees} validate={numeric} />
						<ExpressionInput id="γ2" prelabel={<M>{γ}_2=</M>} size="m" settings={basicTrigonometryInDegrees} validate={numeric} />
					</Par>
				</InputSpace>
			</>
		},
