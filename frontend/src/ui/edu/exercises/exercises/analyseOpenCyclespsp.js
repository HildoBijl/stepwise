...
const steps = [
	...
	},
	{
		...
		Solution: (state) => {
			const { shared: { getCorrect } } = useExerciseData()
			const { P, wn, qin, eta, mdot } = getCorrect(state)
...
const getFeedback = (exerciseData) => {
	return getDefaultFeedback(['p1', 'v1', 'T1', 'p2', 'v2', 'T2', 'p3', 'v3', 'T3', 'p4', 'v4', 'T4', 'q12', 'wt12', 'q23', 'wt23', 'q34', 'wt34', 'q41', 'wt41', 'eta', 'mdot'], exerciseData)
}
