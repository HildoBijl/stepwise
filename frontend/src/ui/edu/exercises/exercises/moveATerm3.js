...
const Problem = (state) => {
	...
	return <>
		...
		<InputSpace>
			<Par>
				<EquationInput id="ans" label="Vul hier de vergelijking in" size="s" settings={basicMathNoFractions} validate={validWithVariables(variables)} />
			</Par>
		</InputSpace>
	</>
}
...
const steps = [
	{
		Problem: (state) => {
			...
			return <>
				...
				<InputSpace><Par><EquationInput id="intermediate" label="Vul hier de vergelijking in" size="s" settings={basicMathNoFractions} validate={validWithVariables(variables)} /></Par></InputSpace>
			</>
		},
		Solution: (state) => {
	...
	},
	{
		Problem: (state) => {
			...
			return <>
				...
				<InputSpace><Par><EquationInput id="ans" label="Vul hier de vergelijking in" size="s" settings={basicMathNoFractions} validate={validWithVariables(variables)} /></Par></InputSpace>
			</>
		},
		Solution: (state) => {
