...
const solutions = [
	<Par>De procescoëfficiënt <M>n</M> is per definitie de waarde <M>n</M> zodat <M>pV^n={`{\\rm constant}`}</M> (Poisson's wet). Als we hier <M>n=0</M> invullen, dan valt <M>V^n</M> weg (want een getal tot de macht nul is altijd één) en houden we <M>pV^n={`{\\rm constant}`}</M>. Dit klopt. Dus geldt hier <M>n=0</M>.</Par>,
