...
const steps = [
	...
	},
	{
		...
		Solution: (state) => {
			...
			const { Q12, W12, Q23, W23, Q34, W34, Q41, W41, Qn, Wn } = getCorrect(state)
			return <>
				<Par>Net als bij stap 2-3 geldt hier <BM>Q_(4-1) = W_(4-1) = pV\ln\left(\frac(V_1)(V_4)\right) = {p4.float} \cdot {V4.float} \cdot \ln\left(\frac{V1.float}{V4.float}\right) = {Q41}.</BM> Hiermee is ook deze stap klaar.</Par>
