...
function Elements({ theta, l1, l2, points, loads, getLoadNames }) {
	...
	return <>
		...
		<Element position={points.B.interpolate(points.C)} graphicalPosition={new Vector(0, distanceShift)} anchor={[0.5, 0.5]} style={distanceLabelStyle}><M>l_2 = {l2}</M></Element>
