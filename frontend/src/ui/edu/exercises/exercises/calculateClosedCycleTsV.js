...
const steps = [
	{
		...
		Solution: () => {
			const { medium, m, Rs, p1, V1, T1, p2, V2, T2 } = useSolution()
			return <>
	...
	},
	{
		...
		Solution: () => {
			const { medium, m, Rs, k, p2, V2, p3, V3, T3 } = useSolution()
