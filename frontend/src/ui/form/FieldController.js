...
const defaultFieldControlOptions = {
	...
	keyboard: null, // A keyboard object describing all the details of what keyboard should be shown when this field is active. When null, no keyboard is shown. For details, see the Keyboard component.
}
