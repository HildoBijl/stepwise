...
export const c = new Quantity('299792458 m/s') // Speed of light.
export const h = new Quantity('6.62607015 * 10^-34 J * s') // Planck constant.
export const k = new Quantity('1.380649 * 10^-23 J / K') // Boltzmann constant.
export const R = new Quantity('8.314462618 J / mol * K') // Universal gas constant.
export const N = new Quantity('6.02214076 * 10^23 / mol') // Avogadro number.

// Molecular constants.

export const e = new Quantity('1.602176634 * 10^-19 C') // Elementary charge.
