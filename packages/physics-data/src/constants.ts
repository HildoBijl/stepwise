...
export const NA = new Quantity('6.02214076 * 10^23 / mol').makeExact() // Avogadro constant.

// Molecular constants.

export const e = new Quantity('1.602176634 * 10^-19 C').makeExact() // Elementary charge.
export const electronMass = new Quantity('9.109383701528 * 10^-31 kg')
export const protonMass = new Quantity('1.6726219236951 * 10^-27 kg')
export const neutronMass = new Quantity('1.6749274980495 * 10^-27 kg')
