...
The [PrecisionNumber](./src/PrecisionNumber/) represents a number with a certain precision. For instance, `2.0 * 10^3` is different from `2000`: they have a different number of significant digits.
