...
type SolutionCallbacks<
	...
	TSolution extends InputExerciseSolution, TInputDependency> = Pick<InputExerciseSpec<InputExerciseMetadata, TParameters, TSolution, TInputDependency>, 'getStaticSolution' | 'updateInputDependency' | 'getSolution'
	>
...
>(
	definition: SolutionCallbacks<TParameters, TSolution, TInputDependency>,
...
>(
	definition: SolutionCallbacks<TParameters, TSolution, TInputDependency>,
	data: UpdateInputDependencyData<TParameters, TSolution, TInputDependency>
