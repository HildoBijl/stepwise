...
export default buildMonoExercise({
	metadata: {
		skill: 'enterEquation',
		comparisons: { ans: (input: Equation, correct: Equation) => !equationComparisons.exactEqual(input, correct.switch()) && equationComparisons.areEquivalent(input, correct.switch()) },
	},
