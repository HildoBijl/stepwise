...
export function deduplicate<T>(array: readonly T[], equals: (a: T, b: T) => boolean = (a, b) => a === b): T[] {
...
export function partition<T, S extends T>(array: readonly T[], filter: (value: T, index: number, array: readonly T[]) => value is S): [kept: S[], removed: Exclude<T, S>[]]
export function partition<T>(array: readonly T[], filter: (value: T, index: number, array: readonly T[]) => boolean): [kept: T[], removed: T[]]
export function partition<T>(array: readonly T[], filter: (value: T, index: number, array: readonly T[]) => boolean): [kept: T[], removed: T[]] {
