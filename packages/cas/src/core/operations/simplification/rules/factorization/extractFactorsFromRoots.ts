...
export const extractFactorsFromRoots = defineRule({
	name: 'extractFactorsFromRoots',
	appliesTo: isRootFunction,
	transform,
	conflictsWith: [combineRootsInProducts, combineProductsWithRoots, combineFractionFactors],
})
