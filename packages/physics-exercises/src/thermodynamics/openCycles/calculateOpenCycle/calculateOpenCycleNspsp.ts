...
const metaData = {
	...
	...stepsToSetup(['calculateOpenProcessStep', 'calculateOpenProcessStep', 'calculateOpenProcessStep']),
...
export function getSolution({ p1o, T1o, p2o, T4o }: ReturnType<typeof generateState>) {
