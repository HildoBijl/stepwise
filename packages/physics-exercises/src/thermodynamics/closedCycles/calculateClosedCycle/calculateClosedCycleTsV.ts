...
export function generateState() {
		...
		const V1o = getRandomFloatUnit({ min: 1, max: 3, significantDigits: 2, unit: 'm^3' })
...
export function getSolution({ medium, p1o, V1o, T1o, p2o }: ReturnType<typeof generateState>) {
