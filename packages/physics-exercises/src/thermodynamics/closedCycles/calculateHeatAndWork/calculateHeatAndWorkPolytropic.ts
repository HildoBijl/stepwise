...
export default buildStepExercise({
	metadata: {
		...
		compare: {
			...
			Rs: { float: { relativeTolerance: 0.01 } },
			cv: { float: { relativeTolerance: 0.01 } },
			c: { float: { relativeTolerance: 0.02, significantDigitTolerance: 2 } },
			Q: { float: { relativeTolerance: 0.02, significantDigitTolerance: 2 } },
			W: { float: { relativeTolerance: 0.02, significantDigitTolerance: 2 } },
		},
	},
		...
		switch (step) {
			...
			case 3:
				switch (substep) {
					...
					case 2: return compare('cv', data)
				}
			case 4: return compare('c', data)
			case 5:
				switch (substep) {
