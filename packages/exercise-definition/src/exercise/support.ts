...
export function getExerciseInitialState<TParameters extends Record<string, unknown> = ExerciseParameters, TState extends ExerciseState = ExerciseState>(getInitialState: ((parameters: TParameters) => TState) | undefined, parameters: TParameters): TState {
