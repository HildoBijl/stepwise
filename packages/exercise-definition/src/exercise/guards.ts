...
export function isExerciseSpec(obj: unknown): obj is ExerciseSpec<any, any> {
	return isPlainObject(obj) && isPlainObject(obj.metaData) && (obj.generateState === undefined || typeof obj.generateState === 'function')
}

export function isExercise(obj: unknown): obj is Exercise<any, any, any, any> {
	return isExerciseSpec(obj) && typeof obj.generateState === 'function' && exerciseModes.some(mode => {
